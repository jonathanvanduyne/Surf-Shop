...
//loop through inventory to display description - type - price
// in uppercase
// const modifiedData = convertDataForAccounting(inventory)
for (let upperCase of inventory) {
    if (convertDataForAccounting(upperCase)) {
        console.log(`${upperCase.description} - ${upperCase.type} - ${upperCase.price}`)
    }
}
